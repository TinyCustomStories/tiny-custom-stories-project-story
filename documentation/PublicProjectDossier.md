...
The September 24 edition extends the original Sprint 0 / early Sprint 1 story without replacing its design language or stable public URL. It now covers the open Sprint 1 outcome gate, Child Map Discovery, the accepted Sprint 3 Story Studio workflow, capability ownership, delivery practice, and the current narrowed open questions.

## Public scope

The dossier may cover product direction, accepted decisions, verified delivery evidence, open questions, logical architecture principles, demonstrated Sprint 0 evidence, Sprint 1 family-mode implementation and gate status, Sprint 2 Discovery, Sprint 3 Story Studio and capability boundaries, outcome-gated delivery, design philosophy, and the reproducible visual recipe.
